		...
		<div class="container">
			...
			<div class="row mb-1">
				<p class="col-12 text-center">
					...
					Copyright &copy; <script>document.write(new Date().getFullYear());</script> All Rights Reserved | Built with <i class="icon-heart text-danger" aria-hidden="true" ></i> by <a href="https://thankgodokoro.codes" target="_blank" stlye="color: #fff;">TeeGee</a>
